              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                {agents.map((a) => (
                  <button
                    ...
                    className="p-4 rounded-lg border border-gray-800/60 bg-gray-900/30 hover:bg-gray-800/40 hover:border-yellow-400/40 transition-all text-left"
                  >
            ...
            <form onSubmit={submit} className="space-y-3">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  placeholder="# 디자인팀&#10;&#10;## 역할&#10;- 시각 디자인 전담&#10;- 에셋 제작/슬라이싱&#10;..."
                  className="w-full rounded-md border border-gray-700 bg-gray-900/60 px-3 py-2 text-sm text-gray-100 placeholder:text-gray-500 font-mono focus:outline-none focus:ring-1 focus:ring-yellow-400/50"
                />
              </div>
