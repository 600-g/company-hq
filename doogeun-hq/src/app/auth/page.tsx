            ...
            <div className="flex gap-1 mb-4 p-1 bg-gray-900/60 rounded border border-gray-800">
              <button
                ...
                className={`flex-1 text-[12px] py-1.5 rounded transition-colors ${
                  mode === "code" ? "bg-yellow-400/20 text-yellow-300 font-bold" : "text-gray-400 hover:text-gray-200"
                }`}
              >
                초대 코드
              </button>
              <button
                ...
                className={`flex-1 text-[12px] py-1.5 rounded transition-colors ${
                  mode === "owner" ? "bg-yellow-400/20 text-yellow-300 font-bold" : "text-gray-400 hover:text-gray-200"
                }`}
              >
                오너
              </button>
