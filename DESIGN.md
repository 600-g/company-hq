...
> 상세: `UNIFIED_DESIGN_GUIDE.md` 참조

### 브레이크포인트
| 이름 | 픽셀 | Tailwind | 레이아웃 |
|------|------|----------|---------|
| mobile | < 375px | (default) | 1열, 풀스크린 |
| mobile-lg | 375px+ | `min-[375px]:` | 표준 모바일 |
| tablet | 768px+ | `md:` | 2열, 사이드바 출현 |
| desktop | 1024px+ | `lg:` | 풀 레이아웃 |
...
- 채팅: 풀스크린 모달 (h-[85vh])
- 사이드바: 숨김 → 바텀시트
- 게임 스케일: `Phaser.Scale.FIT` + `Math.min(dpr, 2)`
